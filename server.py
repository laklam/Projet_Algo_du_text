...
#liste de test pour l'affichage des résultats (à décommenter si on souhaite tester et commenter ligne 7)
...
#initialisation de la liste qui récupère les résultats (en principe elle doit être initialisé avec la fonction de recherche index_inversé qui est en cours d'implémentation)
list_url=[]
